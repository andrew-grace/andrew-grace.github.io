...
I received my PhD from the University of Waterloo in 2022 (my PhD thesis can be found [here](https://uwspace.uwaterloo.ca/items/b4956da7-ac3b-488a-8bb5-051e2a43a401)). During my PhD I studied the influence of the non-linear equation of state on canonical freshwater buoyancy driven flows (penetrative convection and gravity currents). The goal was to understand from a process based standpoint how the non-linear equation of state leads to meaningful modifications to the dynamics of freshwater ecostystems beneath seasonal ice cover.
...
During my postdoctoral research at the University of Notre Dame, I used high resolution simulations of turbulent flows to analyze the the coupled influence of Lagrangian particle inertia and gravity. Using techniques from kinetic theory, we aimed to gain insight into the statistical characteristics of the solid phase to understand the dominant settling mechanisms of large dust grains in the atmospheric surface layer. 

Check out [Research Themes](https://andrew-grace.github.io/research/) for what I've been up to lately!

You can find my CV [here](https://andrew-grace.github.io/files/Academic_CV_Template.pdf)
